...
Func play()
	Local $x, $y
	Local $left_x = 60, $left_y = 130
	Local $right_x = 142, $right_y = 130
	$attack_direct = "left"
	buff()
	buff2()
	buff3()
	...
	While 1
		...
		$left = PixelSearch($left_x, $left_y-3,$left_x+5, $left_y+3,$charColor)
		$right = PixelSearch($right_x-5, $right_y-3,$right_x, $right_y+3,$charColor)
