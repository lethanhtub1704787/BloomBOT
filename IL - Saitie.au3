...
Func play()
	Local $x, $y
	Local $left_x = 79, $left_y = 118
	Local $right_x = 133, $right_y = 118
	$attack_direct = "left"
	buff()
	buff2()
	buff3()
	...
	While 1
		...
		$left = PixelSearch(0, $left_y-5,$left_x+5, $left_y+5,$charColor)
		$right = PixelSearch($right_x-5, $right_y-5,$right_x+20, $right_y+5,$charColor)
